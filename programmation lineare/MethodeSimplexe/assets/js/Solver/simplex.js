...
var theSampleLPString = "Maximize p = 5x + 1y + 6z + 2w subject to " + cr + "4x + 4y + 4z + w <= 44" + cr + "8x + 6y + 4z + 3w <= 36";



var theInstructionString = "Remarques sur le formatage : " + cr + " (1) Les noms de variables doivent commencer par des lettres." + cr + tab + tab + "    (eg. p, x1, loss, z, s, t, u...) " + cr + " (2) Pour les entrées de fractions, conservez la variable à droite." + cr + tab + tab + "    (eg. (1/3)x et non x/3) " + cr + " (3) Every variable you use must appear in the objective function, (mais n'est pas "+cr+"     obligatoire dans les constraintes). " + cr + tab + tab + "    (eg. p = 0x + 2y + 0z ) " + cr + " (4) Les mots « maximiser » (ou « minimiser ») et « sous réserve de » doivent apparaître. " + cr + " (5) Chaque inégalité doit être sur sa propre ligne, comme indiqué. " + cr + " (6) Pas besoin de saisir les contraintes par défaut : x >= 0, y >= 0, z >= 0 etc."
